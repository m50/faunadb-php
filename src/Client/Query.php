 ...
 * @method static Expr Create(mixed $collectionRef, array $params)
 * @method static Expr CreateClass(array $params)
 * @method static Expr CreateCollection(array $params)
 * @method static Expr CreateDatabase(array $params)
 * @method static Expr CreateIndex(array $params)
 * @method static Expr CreateKey(array $params)
 * @method static Expr CreateFunction(array $params)
 * @method static Expr CreateRole(array $params)
 * @method static Expr CreateAccessProvider(array $params)
 ...
 * @method static Expr Events(mixed $refSet)
 ...
 * @method static Expr MatchFunc(mixed $index, mixed ...$terms)
 ...
 * @method static Expr Singleton(mixed $ref)
 * @method static Expr Take(mixed $number, mixed $collection)
 * @method static Expr Union(mixed ...$sets)
